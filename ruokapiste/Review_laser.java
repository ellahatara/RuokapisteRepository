...
/*Review activity, which is for creating a new review to the restaurant. Case: laseri*/

public class Review_laser extends Restaurant3Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.review_laser);
    ...
    private void clickBackButton () {
        backButton = findViewById(R.id.backReviewButton3);
    ...
    public void launchBack () {
        Intent intent = new Intent(Review_laser.this, Restaurant3Activity.class);
