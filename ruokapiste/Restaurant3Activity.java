 ...
 * and creating a new review. Case: Laseri*/

public class Restaurant3Activity extends AppCompatActivity {
    private FloatingActionButton reviewButton3;
    private ImageButton infoButton;
    private CheckBox cb;
    private Button backButton;
    private static int votes = 0;
    String filename = "review_laser.csv";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView reviewDisplay3 = findViewById(R.id.reviewDisplay3);
        ...
        reviewDisplay3.setText("Stars: " + reviewText[0] + "\nReview: " + reviewText[1]);
    ...
    private void configureReviewButton1(){
        reviewButton3 = findViewById(R.id.reviewButton3);
    ...
    private void launchReview(){
        Intent intent = new Intent(Restaurant3Activity.this, Review_laser.class);
        startActivity(intent);
    }
    private void clickInfoButton(){
        infoButton = findViewById(R.id.infoButton3);
    ...
    private void launchInfo(){
        Intent intent = new Intent(Restaurant3Activity.this, Info_laser.class);
        startActivity(intent);
    }
    ...
    public void launchBack () {
        Intent intent = new Intent(Restaurant3Activity.this, MainViewActivity.class);
        startActivity(intent);
    }
}